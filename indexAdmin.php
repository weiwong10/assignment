...
<body style="background-color: #B1DDF1">
    ...
    <div class="w3-bar w3-white w3-wide w3-padding w3-card">
        <a href="indexAdmin.php" class="w3-bar-item w3-button"><b>Admin</b> Page</a>
        <!-- Float links to the right. Hide them on small screens -->
        <div class="w3-right w3-hide-small">
        <a href="indexAdmin.php" class="w3-bar-item w3-button">Home</a>
        <a href="indexGuest.php" class="w3-bar-item w3-button">User Page</a>
       ...
       ?>
        <div class="card">
            ...
            <div class="bottom-text">
               ...
               <div class="btn">
                  <a href="delete.php?Id=<?php echo $row['guestID']?>">Select</a>
               </div>
            </div>
         </div>
